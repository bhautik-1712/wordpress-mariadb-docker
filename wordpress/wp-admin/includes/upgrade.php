...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			$first_post = "<!-- wp:paragraph -->\n<p>" .
			/* translators: First post content. %s: Site link. */
			__( 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing after that moj karo!' ) .
			"</p>\n<!-- /wp:paragraph -->";
		}
		...
		$wpdb->insert(
			...
			array(
				...
				'post_excerpt'          => '',
				'post_title'            => __( 'Hello Bhautik!' ),
				/* translators: Default post slug. */
				'post_name'             => sanitize_title( _x( 'hello-bhautik', 'Default post slug' ) ),
				'post_modified'         => $now,
